...
layout: project
type: project
image: img/firefox_wkPvBzDw33.png
title: "Wonkers Bonkers"
date: 2025
published: true
labels:
  - School Project
...
summary: "My ICS 314 group project."
---

<div class="text-center p-4">
  <img height="600 width="800" src="../img/firefox_wkPvBzDw33.png" class="img-thumbnail" >
</div>
...
Contribution
My work on the Wonkes project primarily entailed the frontend portion, concentrating mostly on the Login and Sign-Up pages. These pages were developed by me using the React, React-Bootstrap, and CSS technologies. The design of the pages is consistent with the entire application.
